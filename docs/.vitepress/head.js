...
export const getHeaders = () => ([
  ...
  ["meta", { property: "twitter:url", value: "https://blog.usword.cn" }],
  ["meta", { property: "twitter:title", value: "hengshuai's blog" }],
  ["meta", { property: "twitter:domain", value: "https://blog.usword.cn" }],
  ["meta", { property: "twitter:card", content: "summary_large_image" }],
  ["meta", { property: "twitter:description", value: "前端开发,Vue,React,webpack,vite,rollup,gulp,nestjs,typescript,前端性能优化,低代码,微前端,node bff,node中间件,node性能优化,混合应用,可视化开发,前端可视化,设计模式,小程序,前端调试指南,前端构建工具,nginx,反向代理,http协议,http protocol,docker,k8s,kubenetes,nodejs,css,regexp,正则表达式,CI/CD,DevOps,Java,Redis,Mysql,Spring,SpringBoot,MyBatis,vue原理,babel,eslint,前端项目规范,编译原理,gitlab,jenkins" }],
  ["meta", { property: "twitter:image", value: "https://blog.usword.cn/logo.png" }],
