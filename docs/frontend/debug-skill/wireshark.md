...
![iShot_2022-10-22_15.44.16.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7e4163efwj31k413cths.jpg)
...
![iShot_2022-10-22_15.49.40.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7e46ruoeyj31k60nk1kx.jpg)

以上看到已经抓取了大量的网络数据包，下面开看看工具栏的作用

![iShot_2022-10-22_15.09.52.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7e3neadwzj31bu04mtal.jpg)
...
![iShot_2022-10-22_16.09.43.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7e4rn2cgqj31k413cdq0.jpg)

除了在欢迎页选择不同的网络接口外，也可以在抓包页面上方的类似设置的按钮中，也可以选择不同的接口和详细的抓包选项，如下图：

![iShot_2022-10-22_16.38.32.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7e5lo5e3vj31f00zak92.jpg)
更详细过滤一些选项
![iShot_2022-10-22_16.02.54.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7e56c27ssj31hu0wk4c0.jpg)
...
![iShot_2022-10-22_16.49.58.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7e5xien0lj31jq0kye3e.jpg)
...
![iShot_2022-10-22_16.57.26.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7e65qwx1fj31dq0awjxz.jpg)
...
![iShot_2022-10-22_17.03.18.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7e6bdfsdzj31iy0a245k.jpg)
...
![iShot_2022-10-23_08.28.31.jpg](https://tva1.sinaimg.cn/large/005HV6Avgy1h7exa6rqjlj31qo0xcjvw.jpg)
...
![iShot_2022-10-22_22.05.39.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7exxpipkwj31k60c2agi.jpg)

ARP请求：
![iShot_2022-10-22_22.09.38.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7exyt2n3ej31js0i07dz.jpg)

ARP应答：
![iShot_2022-10-22_22.13.09.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7exz8j210j31k00jq13r.jpg)
...
![g0ywreqte9.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7f8ebxzb4j30g905u40a.jpg)
...
![iShot_2022-10-23_15.32.54.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7f9dh3pluj31fm0p6476.jpg)
...
看下抓包情况：
![iShot_2022-10-23_15.45.40.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7f9ovwy7kj31k60dwdur.jpg)
从上图抓包记录可以将记录分为三部分：①TCP三次握手连接，②HTTP请求相关，③TCP四次挥手

下面这张图概况了三次握手的摘要
![iShot_2022-10-23_16.19.57.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7faoku3dyj31380lcdrx.jpg)
抓包记录：
![iShot_2022-10-23_15.48.12.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7f9rj9jobj30ss03qtb1.jpg)

1. 这里看出两端通信的端口为`54987`(终端)和`9999`(服务器)，终端发送`SYN`类型请求，指明客户端的初始化序号为0，这里的0位相对值，其真实性值为`3059428279`，并告诉下次的序列号为1，如下图：
![iShot_2022-10-23_15.52.26.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7f9zshnzlj311s0go102.jpg)

2. 服务端接收到客户端的SYN数据包后，发送自己的应答SYN包，并指定自己的序列号0(真实值3338838224)，并将`客户端的序列号+1发送ACK=1确认包(acknumber=3059428280)`，并告诉下次序列号为1，如下图：
![iShot_2022-10-23_16.01.16.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7fa53pnh8j312a0jywnv.jpg)

3. 客户端接收到了服务端的SYN数据包和ACK包后，也将服务端的SYN+1(acknumber = 3338838225)作为ACK数据包发送给服务端，就完成了三次握手
![iShot_2022-10-23_16.11.54.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7fagk4km2j31280kewn3.jpg)
...
来看回收抓包记录：
![iShot_2022-10-23_16.36.34.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7fb5u12owj30yg04on1o.jpg)

1. 在客户端请求完毕后会发送FIN报文给服务端，包含自己的序列号seq=79和ack=125来确认对方最近一次发送的数据，然后表示我没有其他请求了，这时客户端进入`FIN_WAIT1`状态
![iShot_2022-10-23_16.44.22.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7fbdyp9zzj31200hyjyp.jpg)
...
![iShot_2022-10-23_16.47.36.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7fbhbhh94j31240hwn4s.jpg)
3. 等一会时间服务端再发送包含seq=125，ack=80的FIN报文和ACK报文并期待下一次的ACK序列号为126，表示可以断开连接了，服务端进入`LAST_ACK`状态
![iShot_2022-10-23_16.50.48.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7fbkn6yf5j311g0g2wlf.jpg)
...
![iShot_2022-10-23_16.52.15.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7fbm614fxj311k0gatem.jpg)

通过上面的分析已经对四次挥手有了更深理解了，下面再画个图总结下
![iShot_2022-10-23_17.17.26.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7fccd75wkj31gi0qutn3.jpg)
...
![iShot_2022-10-23_17.35.00.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7fcums2gkj30vq04edig.jpg)
- 首先客户端发送GET请求给服务端
...
我们通过跟踪HTTP数据流看下细节：
![iShot_2022-10-23_17.37.10.png](https://tva1.sinaimg.cn/large/005HV6Avgy1h7fcww5re2j311m0f2afi.jpg)
